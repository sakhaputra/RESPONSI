   ...
   exportButton.addEventListener('click', function() {
    ...
    function updateHitCounter() {
        fetch('counter.php')
            ...
            .then(data => {
                document.getElementById('hit_counter').textContent = data.count;
            })
            .catch(error => {
                console.error('Error updating hit counter:', error);
                document.getElementById('hit_counter').textContent = 'Error';
            });
    }

    // Panggil fungsi updateHitCounter saat halaman dimuat
    updateHitCounter();
